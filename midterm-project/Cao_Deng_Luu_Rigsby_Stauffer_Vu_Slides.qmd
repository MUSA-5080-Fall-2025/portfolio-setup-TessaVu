...
## Why This Matters to the Office of Property Assessment
...
::: {.column width = "45%"}
![](slide_images\log-model.png)
:::

::: {.column width = "46%"}
![](slide_images\kable-model.png)
:::
...
- Overvalues some disinvested neighborhoods and undervalues wealthier ones.

- Areas with residents depend more on personal vehicles, this model is predicting on public transit, not highways.

**Future Potential:**

- Incorporate additional categorical variables after consideration, like land use and employment for university areas.
