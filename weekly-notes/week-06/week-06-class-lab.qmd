...
::::: columns
::: {.column width="50%"}
🏘️ Not Wealthy Areas Equation: Price = `r scales::dollar(base_intercept, accuracy = 1)` + `r scales::dollar(base_slope, accuracy = 1)` × LivingArea Interpretation:

Base price: `r scales::dollar(base_intercept, accuracy = 1)` Each sq ft adds: `r scales::dollar(base_slope, accuracy = 1)`
:::

::: {.column width="50%"}
🏛️ Wealthy Areas Equation: Price = `r scales::dollar(wealthy_intercept, accuracy = 1)` + `r scales::dollar(wealthy_slope, accuracy = 1)` × LivingArea Interpretation:

Base price: `r scales::dollar(wealthy_intercept, accuracy = 1)` Each sq ft adds: `r scales::dollar(wealthy_slope, accuracy = 1)`
:::
:::::

::: callout-important
The Interaction Effect Wealthy areas value each sq ft `r scales::dollar(wealthy_slope_add, accuracy = 1)` more than non-wealthy areas!
:::
...
::: callout-important
Model Improvement Adding the interaction improves R² by `r round(r2_improvement, 4)` (a `r round(r2_pct_improvement, 1)`% relative improvement)
...
Model equation: Price = `r scales::dollar(coefs_quad[1], accuracy = 1)` + `r scales::dollar(beta_age, accuracy = 1)`×Age + `r scales::dollar(beta_age2, accuracy = 2)`×Age² + `r scales::dollar(coefs_quad["LivingArea"], accuracy = 1)`×LivingArea
...
2.  **Final cross-validated RMSE:** \$\_\_\_\_\_\_\_\_\_\_\_\_ and **MAE** \$\_\_\_\_\_\_\_\_\_\_\_\_\_\_
