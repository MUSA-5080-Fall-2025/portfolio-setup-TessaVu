...
- **NOTE:** There are 60 NA tracts with age population data, but no income data, and it would've been misleading to label the median income as $0 when there's a lack of data. The NA category is necessary, not lumping the tracts in with vulnerable nor non-vulnerable tracts.
